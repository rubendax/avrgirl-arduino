...
Connection.prototype._pollForOpen = function (callback) {
  ...
  var poll = awty(function (next) {
    _this.serialPort.open(function (error) {
      // patch for Native USB on Mac OS //////////////////////////////////////////////////////////////////////////
      if (error && process.platform == 'darwin') {
        console.log("Re-initializing Serialport connection for Native USB");
        Serialport.list().then(ports => {
          ...
          console.log("Trying to open temporary port at " + _this.options.port);
